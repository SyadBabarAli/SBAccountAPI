...
{
    public class SaleRecurringInvoice
    {
        [Key, Column(Order = 1)] public int CompanyId { get; set; }
        [Key, Column(Order = 2)] public int SaleRecurringInvoiceId { get; set; }
        ...
        public List<SaleRecurringInvoiceDetail> SaleRecurringInvoiceDetail { get; set; }
    }
}