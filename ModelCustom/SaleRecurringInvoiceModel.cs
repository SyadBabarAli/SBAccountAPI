...
{
    public class SaleRecurringInvoiceModel
    {
        ...
        public List<SaleRecurringInvoiceDetailModel> SaleRecurringInvoiceDetailModel { get; set; }

        public List<Models.SettingFrequency> settingFrequencyModel { get; set; }
        public List<Models.SettingStatus> settingStatusModel { get; set; }
